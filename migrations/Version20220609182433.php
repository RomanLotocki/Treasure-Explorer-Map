 ...
 */
final class Version20220609182433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, site_id INT DEFAULT NULL, item_name VARCHAR(255) NOT NULL, item_image VARCHAR(255) NOT NULL, item_description LONGTEXT NOT NULL, discovery_description LONGTEXT DEFAULT NULL, creation_date VARCHAR(255) NOT NULL, discovery_date VARCHAR(255) DEFAULT NULL, item_latitude DOUBLE PRECISION NOT NULL, item_longitude DOUBLE PRECISION NOT NULL, item_country VARCHAR(100) NOT NULL, item_culture VARCHAR(100) NOT NULL, item_materials VARCHAR(255) DEFAULT NULL, item_conservation_site VARCHAR(255) DEFAULT NULL, item_conservation_site_url VARCHAR(255) DEFAULT NULL, INDEX IDX_1F1B251EF6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
